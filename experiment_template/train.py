...
from FarkasLayers.experiment_template import dataloader
from FarkasLayers.experiment_template.dataloader import cutout
from FarkasLayers import models as models
...
model_args.update(bn=args.bn, classes=classes, bias=args.bias,
                  ...
                  dropout=args.dropout,weight_init=args.weight_init,zero_last=args.zero_last,
                  )

#Load FarkasNet --- change to models.cifar if you want standard ResNets
if args.dataset in ['cifar10','cifar100']:
    model = getattr(models.farkas, args.model)(**model_args)
