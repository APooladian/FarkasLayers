...
group1.add_argument('--weight-init',type=str,default='standard',
        choices=['standard','xavier','kaiming'],required=True,dest='weight_init')
group1.add_argument('--zero-last',action='store_true',dest='zero_last')
group1.add_argument('--no-zero-last',action='store_false',dest='zero_last')
